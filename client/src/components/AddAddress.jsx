            ...
            <div className="modal mx-auto my-8 max-w-lg">
                <div className="modal-head">
                    <div>
                        ...
                        <h2 className="mt-1 font-display text-base font-semibold">Add address</h2>
                    </div>
                ...
                <form className="grid gap-4 p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type="submit" className="btn-primary btn-block btn-lg mt-2">Save address</button>
                </form>
            </div>
        </section>
    )
