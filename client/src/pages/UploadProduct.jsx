      ...
      <div className="grid p-3">
        <form className='grid gap-4' onSubmit={handleSubmit}>
              ...
              <div className="flex flex-wrap gap-4">
                {
                  data.image.map((img, index) => {
                    return (
                      <div key={img + index} className="mt-1 h-20 w-20 min-w-20 bg-blue-50 border relative group">
                        <img
                          src={img}
                          alt={img}
                          className='w-full h-full object-scale-down cursor'
          ...
          <div className='grid gap-1'>
            ...
            <div>
              <select
                className='w-full bg-blue-50 p-2 rounded'
              ...
              <div className="flex flex-wrap gap-3">
                {
                  data.category.map((c, index) => {
                    return (
                      <div key={c._id + index + "category"} className="text-sm flex items-center gap-1 bg-blue-50 mt-2">
                        <p>{c.name}</p>
          ...
          <div onClick={() => setOpenAddField(true)} className=' hover:bg-primary-100 bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 hover:text-neutral-900 cursor-pointer rounded'>
            Add Fields
          </div>
